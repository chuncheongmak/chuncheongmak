...
var mongodbURL = 'mongodb://chuncheongmak:war3war3war3@ds054118.mongolab.com:54118/MongoLab-j';
var mongoose = require('mongoose');

app.post('/',function(req,res) {
	//console.log(req.body);
	var restaurantSchema = require('.models/restaurant');
	mongoose.connect('mongodb://chuncheongmak:war3war3war3@ds054118.mongolab.com/MongoLab-j/');
